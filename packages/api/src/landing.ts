...
<body>
  ...
  <section class="hero">
    ...
    <p class="hero-sub">Built on CKB Fiber Network · Open source · Zero custody</p>
...
<span class="tag">payment</span>.<span class="attr">custody</span> = <span class="str">"none"</span></div>
  ...
  <footer>
    <p>Built with 💜 on the <a href="https://www.nervos.org" target="_blank">Nervos CKB</a> Fiber Network</p>
